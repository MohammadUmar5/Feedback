...
export default function FeedbackGroup({ title }) {
  return (
    <div className="space-y-4 mb-6 h-15 sm:h-15 md:h-15 w-150 sm:w-290 md:w-290 relative right-6 z-0 border-b border-zinc-700 pb-4 flex items-center justify-between ">
