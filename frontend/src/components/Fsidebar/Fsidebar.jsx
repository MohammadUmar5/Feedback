...
export default function Fsidebar({ onArrowClick }) {
  return (
    <div
      className="z-10 fixed top-0 left-0 w-30 sm:w-64 md:w-68 h-screen text-white p-4 border-r border-zinc-800"
    ...
    >
      <div className="filterName flex items-center justify-start">
        ...
        <h2 className="text-lg sm:text-sm md:text-xl ml-1.5 sm:ml-4 md:ml-4 font-bold text-purple-400 mb-3">Filters</h2>
      </div>
